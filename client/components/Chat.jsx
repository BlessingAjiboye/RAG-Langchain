...
const callChatAPI = async (
  ...
  const { data } = await axios({
    method: "get",
    url: `${import.meta.env.VITE_REACT_APP_API_URL}v1/in-memory-ai-text`,
...
const avatar1 = `${import.meta.env.VITE_REACT_APP_BASE_URL}avatar1.png`;
const avatar2 = `${import.meta.env.VITE_REACT_APP_BASE_URL}avatar2.png`;
